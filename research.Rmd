...
<form><input onclick="showAbstract('local_agenda')" type = "button" value = "Abstract" class="button"></form>
<!-- <form action="files/papers/zzzzzz.pdf"> <input type="submit" class="button" value="Ungated PDF"></form>   -->
<!-- <form action="https://doi.org/10.7910/DVN/CFPBRI"> <input type="submit" class="button" value="Replication Materials"></form> -->
