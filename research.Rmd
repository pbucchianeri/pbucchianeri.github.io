...
<form action="files/papers/PB_Competition_Appendix_Web"> <input type="submit" class="button" value="Appendix"></form>
<form action="https://doi.org/10.7910/DVN/8ZT2ID"> <input type="submit" class="button" value="Replication Materials"></form>
<div id="pb2020_partycomp" style="display: none">
...
<div id="pb2018" style="display: none">
