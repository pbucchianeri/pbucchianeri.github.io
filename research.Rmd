...
Bucchianeri, Peter. 2020. ["Party Competition and Coalitional Stability: Evidence from American Local Government"](https://doi.org/10.1017/S0003055420000386). *American Political Science Review*, 114(4): 1055-1070.
<form><input onclick="showAbstract('pb2020_partycomp')" type = "button" value = "Abstract" class="btn btn-primary btn-xs"></form>
<form action="files/papers/PB_Competition_Web_Final.pdf"> <input type="submit" class="btn btn-primary btn-xs" value="Ungated PDF"></form>
<form action="files/papers/PB_Competition_Appendix_Web.pdf"> <input type="submit" class="btn btn-primary btn-xs" value="Appendix"></form>
<form action="https://doi.org/10.7910/DVN/8ZT2ID"> <input type="submit" class="btn btn-primary btn-xs" value="Replication Materials"></form>
...
<div style="float: left; padding-left: 20px; margin-bottom: 20px">
Bucchianeri, Peter. 2018. ["Is Running Enough? Reconsidering the Conventional Wisdom about Women Candidates"](https://doi.org/10.1007/s11109-017-9407-7). *Political Behavior* 40(2): 435-466.
<form><input onclick="showAbstract('pb2018')" type = "button" value = "Abstract" class="btn btn-primary btn-xs"></form>
<form action="files/papers/Bucchianeri_IsRunningEnough.pdf"> <input type="submit" class="btn btn-primary btn-xs" value="Ungated PDF"></form>  
<form action="https://doi.org/10.7910/DVN/CFPBRI"> <input type="submit" class="btn btn-primary btn-xs" value="Replication Materials"></form>
...
<form><input onclick="showAbstract('bvw_sles')" type = "button" value = "Abstract" class="btn btn-primary btn-xs"></form>
<form action="files/papers/BVW_SLES_Web.pdf"> <input type="submit" class="btn btn-primary btn-xs" value="Working Draft"></form>
<!-- <form action="https://doi.org/10.7910/DVN/CFPBRI"> <input type="submit" class="btn btn-primary btn-xs" value="Replication Materials"></form> -->
...
<form><input onclick="showAbstract('pb_sf')" type = "button" value = "Abstract" class="btn btn-primary btn-xs"></form>
<form action="files/papers/PB_SF_Progressives_Web.pdf"> <input type="submit" class="btn btn-primary btn-xs" value="Working Draft"></form>
<!-- <form action="https://doi.org/10.7910/DVN/CFPBRI"> <input type="submit" class="btn btn-primary btn-xs" value="Replication Materials"></form> -->
...
<form><input onclick="showAbstract('local_officials')" type = "button" value = "Abstract" class="btn btn-primary btn-xs"></form>
<form action="files/papers/Local_Officials_Web.pdf"> <input type="submit" class="btn btn-primary btn-xs" value="Working Draft"></form>
<!-- <form action="https://doi.org/10.7910/DVN/CFPBRI"> <input type="submit" class="btn btn-primary btn-xs" value="Replication Materials"></form> -->
...
<form><input onclick="showAbstract('bvw_state_to_fed')" type = "button" value = "Abstract" class="btn btn-primary btn-xs"></form>
<!-- <form action="files/papers/zzzzzzz.pdf"> <input type="submit" class="btn btn-primary btn-xs" value="Ungated PDF"></form>   -->
<!-- <form action="https://doi.org/10.7910/DVN/CFPBRI"> <input type="submit" class="btn btn-primary btn-xs" value="Replication Materials"></form> -->
...
<!-- PB -- Race, Partisanship, and the Construction of the Local Legislative Agenda  -->
<div style="float: left; padding-left: 20px; margin-bottom: 20px">
"Race, Partisanship, and the Construction of the Local Legislative Agenda"
<form><input onclick="showAbstract('local_agenda')" type = "button" value = "Abstract" class="btn btn-primary btn-xs"></form>
<!-- <form action="files/papers/zzzzzz.pdf"> <input type="submit" class="btn btn-primary btn-xs" value="Ungated PDF"></form>   -->
<!-- <form action="https://doi.org/10.7910/DVN/CFPBRI"> <input type="submit" class="btn btn-primary btn-xs" value="Replication Materials"></form> -->
<div id="local_agenda" style="display: none; margin-top: 12px">
